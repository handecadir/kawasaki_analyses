...
```{r}
File.Bed = "./kawasaki/plink/kegg_genes_lof_case_control.bed"
File.Bim = "./kawasaki/plink/kegg_genes_lof_case_control.bim"
File.Fam = "./kawasaki/plink/kegg_genes_lof_case_control.fam"
File.SetID = "./kawasaki/plink/kegg_genes_lof_clean.SetID"
File.SSD = "./kawasaki/plink/kegg_genes_lof_case_control.SSD"
File.Info = "./kawasaki/plink/kegg_genes_lof_case_control.SSD.info"
```
...
if (nrow(all_pathways_sorted) > 0) {
  ...
  plot_all_pathways <- ggplot(all_pathways_sorted, aes(x = SetID_ordered, y = P.value)) +
    ...
    coord_flip() + 
    labs(
      title = "Pathway p-Values:LoF Case-Control Status",
      x = "Pathway",
      y = "p-Value"
    ) +
  ...
  ggsave("skat_lof_case_control.png", plot = plot_all_pathways, width = 10, height = max(7, nrow(all_pathways_sorted) * 0.15))
...
if(nrow(significant_pathways) > 0) {
  ...
  output_file <- "./kawasaki/plink/significant_pathways_snps_lof_case_control.csv"

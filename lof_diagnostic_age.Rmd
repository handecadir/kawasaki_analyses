...
```{r}
File.Bed = "./kawasaki/plink/kegg_genes_lof_diagnostic_age.bed"
File.Bim = "./kawasaki/plink/kegg_genes_lof_diagnostic_age.bim"
File.Fam = "./kawasaki/plink/kegg_genes_lof_diagnostic_age.fam"
File.SetID = "./kawasaki/plink/kegg_genes_lof_clean.SetID"
File.SSD = "./kawasaki/plink/kegg_genes_lof_diagnostic_age.SSD"
File.Info = "./kawasaki/plink/kegg_genes_lof_diagnostic_age.SSD.info"
```
...
if (nrow(all_pathways_sorted) > 0) {
  ...
  plot_all_pathways <- ggplot(all_pathways_sorted, aes(x = SetID_ordered, y = P.value)) +
    ...
    coord_flip() + 
    labs(
      title = "Pathway p-Values:LoF Diagnostic Age",
      x = "Pathway",
      y = "p-Value"
    ) +
  ...
  ggsave("skat_lof_diagnostic_age.png", plot = plot_all_pathways, width = 10, height = max(7, nrow(all_pathways_sorted) * 0.15))

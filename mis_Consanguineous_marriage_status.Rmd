...
```{r}
File.Bed = "./kawasaki/plink/kegg_genes_mis_Consanguineous_marriage_status.bed"
File.Bim = "./kawasaki/plink/kegg_genes_mis_Consanguineous_marriage_status.bim"
File.Fam = "./kawasaki/plink/kegg_genes_mis_Consanguineous_marriage_status.fam"
File.SetID = "./kawasaki/plink/kegg_genes_mis_clean.SetID"
File.SSD = "./kawasaki/plink/kegg_genes_mis_Consanguineous_marriage_status.SSD"
File.Info = "./kawasaki/plink/kegg_genes_mis_Consanguineous_marriage_status.SSD.info"
```
...
if (nrow(all_pathways_sorted) > 0) {
  ...
  plot_all_pathways <- ggplot(all_pathways_sorted, aes(x = SetID_ordered, y = P.value)) +
    ...
    coord_flip() + 
    labs(
      title = "Pathway p-Values:Missense Consanguineous Marriage Status",
      x = "Pathway",
      y = "p-Value"
    ) +
  ...
  ggsave("skat_mis_Consanguineous_marriage_status.png", plot = plot_all_pathways, width = 10, height = max(7, nrow(all_pathways_sorted) * 0.15))
...
if(nrow(significant_pathways) > 0) {
  ...
  output_file <- "./kawasaki/plink/significant_pathways_snps_mis_Consanguineous_marriage_status.csv"

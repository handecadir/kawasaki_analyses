...
```{r}
File.Bed = "./kawasaki/plink/kegg_genes_mis_Sequelae_Status.bed"
File.Bim = "./kawasaki/plink/kegg_genes_mis_Sequelae_Status.bim"
File.Fam = "./kawasaki/plink/kegg_genes_mis_Sequelae_Status.fam"
File.SetID = "./kawasaki/plink/kegg_genes_mis_clean.SetID"
File.SSD = "./kawasaki/plink/kegg_genes_Sequelae_Status.SSD"
File.Info = "./kawasaki/plink/kegg_genes_mis_Sequelae_Status.SSD.info"
```
...
if (nrow(all_pathways_sorted) > 0) {
  ...
  plot_all_pathways <- ggplot(all_pathways_sorted, aes(x = SetID_ordered, y = P.value)) +
    ...
    coord_flip() + 
    labs(
      title = "Pathway p-Values:Missense Sequelae Status",
      x = "Pathway",
      y = "p-Value"
    ) +
  ...
  ggsave("skat_mis_Sequelae_Status.png", plot = plot_all_pathways, width = 10, height = max(7, nrow(all_pathways_sorted) * 0.15))
...
if(nrow(significant_pathways) > 0) {
  ...
  output_file <- "./kawasaki/plink/significant_pathways_snps_mis_Sequelae_Status.csv"

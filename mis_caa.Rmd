...
```{r}
File.Bed = "./kawasaki/plink/kegg_genes_mis_caa.bed"
File.Bim = "./kawasaki/plink/kegg_genes_mis_caa.bim"
File.Fam = "./kawasaki/plink/kegg_genes_mis_caa.fam"
File.SetID = "./kawasaki/plink/kegg_genes_mis_clean.SetID"
File.SSD = "./kawasaki/plink/kegg_genes_mis_caa.SSD"
File.Info = "./kawasaki/plink/kegg_genes_mis_caa.SSD.info"
```
...
if (nrow(all_pathways_sorted) > 0) {
  ...
  plot_all_pathways <- ggplot(all_pathways_sorted, aes(x = SetID_ordered, y = P.value)) +
    ...
    coord_flip() + 
    labs(
      title = "Pathway p-Values:Missense CAA Status",
      x = "Pathway",
      y = "p-Value"
    ) +
  ...
  ggsave("skat_mis_caa.png", plot = plot_all_pathways, width = 10, height = max(7, nrow(all_pathways_sorted) * 0.15))
...
if(nrow(significant_pathways) > 0) {
  ...
  output_file <- "./kawasaki/plink/significant_pathways_snps_mis_caa.csv"
